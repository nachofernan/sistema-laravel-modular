...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'capacitaciones' => [
            'driver' => 'local',
            'root' => storage_path('app/public/capacitaciones'),
            'url' => env('APP_URL').'/storage/capacitaciones',
            'visibility' => 'public',
            'throw' => false,
        ],
        ...
        'proveedores' => [
            'driver' => 'local',
            'root' => storage_path('app/public/proveedores'),
        ...
        'concursos' => [
            'driver' => 'local',
            'root' => storage_path('app/public/concursos'),
