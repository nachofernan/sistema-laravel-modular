                        ...
                        <div class="space-y-6">
                            ...
                            <div id="campos-ofertas">
                                ...
                                <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            <label for="encriptado" class="block text-sm font-medium text-gray-700 mb-1">Encriptado por defecto</label>
                                            <select id="encriptado" name="encriptado" 
                                                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                                <option value="0">No</option>
                                                <option value="1">Sí</option>
                                            </select>
                                            <p class="mt-1 text-xs text-gray-500">Los documentos encriptados requieren contraseña para ser visualizados</p>
                                        </div>
