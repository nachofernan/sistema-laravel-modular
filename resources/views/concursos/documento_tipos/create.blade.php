<x-app-layout>
    <div class="w-full xl:w-10/12 mb-12 xl:mb-0 px-4 mx-auto mt-4">
        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
            <form action="{{ route('concursos.documento_tipos.store') }}" method="POST">
                {{ csrf_field() }}
                        ...
                        <div class="col">
                            <div class="grid-datos-show">
                                ...
                                <div class="valor-edit">
                                    <input type="text" name="nombre" value="{{ old('nombre') }}" class="input-full"
                                ...
                                <div class="valor-edit">
                                    <textarea type="text" name="descripcion" rows="4" value="{{ old('descripcion') }}" class="input-full"
                                ...
                                <div class="valor-edit">
                                    <select name="de_concurso" id="de_concurso" class="input-full">
                                    ...
                                    <div class="valor-edit">
                                        <select name="tipo_documento_proveedor_id" class="input-full">
                                            ...
                                            @foreach ($tipo_documento_proveedor as $tipo_documento)
                                                <option value="{{ $tipo_documento->id }}">{{ $tipo_documento->nombre }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
