<div>
    <button class="inline-flex items-center px-2 py-1 bg-red-600 hover:bg-red-700 text-white text-xs font-medium rounded transition-colors" wire:click="$set('open', true)"> 
        ...
        <x-slot name="content"> 
            <form action="{{route('proveedores.documentos.destroy', $documento)}}" method="POST">
                ...
                <div class="bg-red-50 border border-red-200 rounded-lg px-4 py-3 mb-4">
                    ...
                    <p class="text-red-700 text-sm mt-1">Esta acción no puede deshacerse. Se eliminará el documento permanentemente.</p>
                </div>
