    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4">
            ...
            <div>
                ...
                <select wire:model.live="vehiculo_filter" 
                        id="vehiculo_filter"
                        class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <a href="{{ route('automotores.vehiculos.show', $copre->vehiculo) }}" class="text-sm font-medium text-blue-600 hover:text-blue-900 transition-colors">
                                            {{ $copre->vehiculo->marca }} {{ $copre->vehiculo->modelo }}
                                        </a>
                                        <div class="text-xs text-gray-500">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $copre->numero_ticket_factura }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $copre->cuit }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                    {{ number_format($copre->litros, 2) }} L
                                </span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="text-sm text-gray-900">${{ number_format($copre->precio_x_litro, 2) }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="text-sm font-medium text-gray-900">${{ number_format($copre->importe_final, 2) }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                @if($copre->km_vehiculo)
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $copre->chofer->name ?? 'N/A' }}</div>
                            </td>
