    ...
    <x-dialog-modal wire:model="open"> 
        ...
        <x-slot name="content" class="text-sm"> 
            <h1 class="h1 pb-2 border-b border-gray-300 text-xl text-center">
                Editar Rol: <strong>{{$role->nombre}}</strong>
            </h1>
            <div class="grid grid-cols-12 gap-3 px-5 py-3 border-b border-gray-300  text-left"> 
                ...
                <div class="col-span-6 font-bold">
                    <input type="text" wire:model="nombre" class="rounded w-full border-b" placeholder="Editar Rol">
                </div>
                <div class="col-span-3 text-center">
                    <button wire:click="create()" class="boton-celeste w-full py-2 mt-1">Editar Rol</button>
                </div>
            </div>
