<x-app-layout>
    <div class="w-full xl:w-10/12 mb-12 xl:mb-0 px-4 mx-auto mt-4">
        <div class="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
            <form action="{{ route('proveedores.documento_tipos.store') }}" method="POST">
                {{ csrf_field() }}
                        ...
                        <div class="col">
                            ...
                            <div class="grid-datos-show">
                                ...
                                <div class="valor-edit">
                                    <input type="text" name="codigo" value="{{ old('codigo') }}" class="input-full" placeholder="Código" required>
