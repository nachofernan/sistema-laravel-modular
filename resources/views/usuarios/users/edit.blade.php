                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <select id="area_id" 
                                        ...
                                        @livewire('usuarios.areas.foreach-select', ['areas' => $areas, 'selected' => old('area_id', $user->area_id ?? 0), 'nivel' => ''])
                                    </select>
                                    @error('area_id')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="date" 
                                               id="cumpleanos"
                                               name="cumpleanos" 
                                               value="{{ old('cumpleanos', $user->cumpleanos ? \Carbon\Carbon::parse($user->cumpleanos)->format('Y-m-d') : '') }}" 
                                    ...
                                    <div>
                                        ...
                                        <input type="date" 
                                               id="ingreso"
                                               name="ingreso" 
                                               value="{{ old('ingreso', $user->ingreso ? \Carbon\Carbon::parse($user->ingreso)->format('Y-m-d') : '') }}" 
