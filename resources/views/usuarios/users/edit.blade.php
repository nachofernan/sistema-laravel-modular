                        ...
                        <div class="col">
                            ...
                            <div class="grid-datos-show">
                                ...
                                <div class="valor-edit">
                                    <input type="checkbox" name="visible" class="mt-2 rounded" @checked($user->visible)>
                                </div>
                                <div class="atributo-edit">
                                    Nombre de Usuario
                                </div>
                                <div class="valor-edit">
                                    <input type="text" name="name" value="{{ $user->name }}" class="input-full"
                                ...
                                <div class="valor-edit">
                                    <input type="text" name="realname" value="{{ $user->realname }}"
                                        class="input-full" placeholder="Nombre Real">
                                </div>
                                <div class="atributo-edit">
                                    Correo Electrónico
                                </div>
                                <div class="valor-edit">
                                    <input type="text" name="email" value="{{ $user->email }}" class="input-full"
                                ...
                                <div class="valor-edit">
                                    <input type="text" name="legajo" value="{{ $user->legajo }}" class="input-full"
                                        placeholder="Legajo">
                                </div>
                                <div class="atributo-edit">
                                    Interno
                                ...
                                <div class="valor-edit">
                                    <input type="text" name="interno" value="{{ $user->interno }}"
                                        class="input-full" placeholder="Interno">
                                </div>
                                <div class="atributo-edit">
                                    Sede
                                    ...
                                    <select name="sede_id" class="input-full">
                                        ...
                                        @foreach ($sedes as $sede)
                                            <option value="{{ $sede->id }}"
                                                {{ $user->sede && $sede->id === $user->sede->id ? 'selected' : '' }}>
                                                {{ $sede->nombre }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="valor-edit">
                                    <select name="area_id" class="input-full">
                                        <option value="">Ninguno</option>
                                        @livewire('usuarios.areas.foreach-select', ['areas' => $areas, 'area_id' => $user->area->id ?? 0, 'disabled' => false, 'nivel' => ''])
                                    </select>
                                </div>
                            </div>
                        </div>
