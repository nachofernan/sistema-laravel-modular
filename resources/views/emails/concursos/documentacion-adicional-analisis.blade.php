...
<head>
    ...
    <title>Documentación Adicional Cargada</title>
    <!--[if mso]>
    <style type="text/css">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        <td style="padding: 0 0 20px 0;">
                            ...
                            <p style="margin: 0; font-size: 16px; color: #4B5563;">
                                Se ha cargado documentación adicional en la oferta del concurso de referencia,
                                estando el concurso en etapa de análisis.
                                <br><br>
                                <strong>Proveedor:</strong> {{ $proveedor->razonsocial }} (CUIT: {{ $proveedor->cuit }}).
                                <br><br>
                            ...
                            <p style="margin: 10px 0 10px 0; font-size: 16px; color: #4B5563;">Para revisar el documento acceda al siguiente enlace:</p>
                        </td>
                    </tr>
