                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        <td style="padding: 0 0 20px 0;">
                            ...
                            <p style="margin: 0; font-size: 16px; color: #4B5563;">
                                ...
                                <br><br>
                                <strong>Descripción del Concurso:</strong> {{ $prorroga->concurso->descripcion }}.
                                <br><br>
                                <strong>NUEVA Fecha de Cierre:</strong> {{ $prorroga->concurso->fecha_cierre->format('d-m-Y H:i') }}.
                            </p>
                    ...
                    <tr>
                        <td style="padding: 10px 0 30px 0;" align="center">
                            <!--[if mso]>
                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://172.17.9.231/portalproveedores/public/concursos/{{ $prorroga->concurso->id }}" style="height:40px;v-text-anchor:middle;width:200px;" arcsize="10%" stroke="f" fillcolor="#002E80">
                                <w:anchorlock/>
                                <center>
                            <![endif]-->
                            @if (app()->environment('production'))
                                <a href="https://buenosairesenergia.com.ar/registroproveedores/concursos/{{ $prorroga->concurso->id }}" 
                            @else
                                <a href="http://172.17.9.231/portalproveedores/public/concursos/{{ $prorroga->concurso->id }}" 
                            @endif
