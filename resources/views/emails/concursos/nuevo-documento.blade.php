                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        <td style="padding: 10px 0 30px 0;" align="center">
                            <!--[if mso]>
                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://buenosairesenergia.com.ar/registroproveedores/concursos/{{ $documento->concurso_id }}" style="height:40px;v-text-anchor:middle;width:200px;" arcsize="10%" stroke="f" fillcolor="#002E80">
                                <w:anchorlock/>
                                <center>
                            <![endif]-->
                            <a href="https://buenosairesenergia.com.ar/registroproveedores/concursos/{{ $documento->concurso_id }}" 
