...
<head>
    ...
    <title>Aviso de Documentación con Vencimiento</title>
    <!--[if mso]>
    <style type="text/css">
        ...
        <tr>
            <td style="padding: 30px 20px;">
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#F2FEF2" style="border: 1px solid #a1d89f; border-radius: 4px;">
                                <tr>
                                    <td style="padding: 15px 20px;">
                                        <h2 style="margin: 0; font-size: 16px; color: #1f991b; text-align: center;">Se solicita actualizar la documentación del proveedor</h2>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding: 0 0 20px 0;">
                            <h2 style="margin: 0 0 15px 0; font-size: 18px; color: #1F2937;">Proveedor: {{$proveedor->razonsocial}}</h2>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 10px 0 30px 0;" align="center">
                            <!--[if mso]>
                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://172.17.8.80/plataforma/proveedores/proveedors/{{$proveedor->id}}" style="height:40px;v-text-anchor:middle;width:200px;" arcsize="10%" stroke="f" fillcolor="#002E80">
                                <w:anchorlock/>
                                <center>
                            <![endif]-->
                            <a href="http://172.17.8.80/plataforma/proveedores/proveedors/{{$proveedor->id}}" 
